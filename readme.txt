...
Tags: infographics, infographic, infographic maker, data visualization, charts, charts and graphs, html5 charts, content curation, infographics builder, data visualizer
...
Infographic maker with charts and graphs. Build HTML, Responsive infographics & elegant Text or Image Lists quickly.

== Description ==
= Infographics and List Maker with Charts and Graphs - iList =
...
> <strong>Tons of extra features and 55+ templates available with iList pro!</strong><br>
...
iList, Infographic maker, comes bundled with 20+ modern and great looking Infographic, text or image List templates that are fully Responsive, Masonry and integrates with your current theme easily.  We are working on *more templates* to release soon.
...
1. 55+ Templates in Total with easy template selector and template switcher
2. Responsive, Editable, Animated
3. Upvote for Individual iList Items
4. Customize All Colors/Fonts
5. Use predefined fonts or choose from 800+ google Fonts
6. Make Dynamic Infographic more Easily
7. Create Elegent Text Lists
8. Create Elegent Graphics Lists
9. Easy Short Code Generator
10. Powerful short code options for extensive control over display
11. RTL support
12. Custom CSS to add your own style
13. Embed option. Other website owners can now embed the useful Infographics and lists you create on their websites with a backlink to your own website. Great for SEO!
14. Font Awesome Integration - select font (or use your image) to quickly create iList items
15. Bar chart, Line Chart, Polar Area Chart, Radar Chart, Pie Chart and  Doughnut Chart
16. Add charts and graphs in middle area for supporting templates
17. iChart editor button that lets you create chart on any page anywhere - even without an iList!
